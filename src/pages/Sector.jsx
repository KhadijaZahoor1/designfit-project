          ...
          <div className="lg:w-[50%] flex">
            <div className="self-center lg:px-[60px] relative">
              ...
              <p className="font-Mulish font-normal text-[18px] leading-[30px] text-pantone1 mt-[20px]">
                ...
                office. As a matter of fact, most of us spend most of our time
                in our work environment, where we need to stay productive and
          ...
          <div className="lg:w-[50%] flex">
            <div className="self-center lg:px-[60px] relative">
              ...
              <p className="font-Mulish font-normal text-[18px] leading-[30px] text-pantone1 mt-[20px]">
                ...
                important it is to create retail spaces that offer unique
                customer experiences in-store. Our designs stand out regardless
                of what kind of retail space our clients require, whether it's a
                pet shop, luxury boutique or warehouse.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:w-[50%] flex">
            <div className="self-center lg:px-[60px] relative">
              ...
              <p className="font-Mulish font-normal text-[18px] leading-[30px] text-pantone1 mt-[20px]">
                ...
                dining, unique restaurants and bars with the right atmosphere
                and interior design will attract customers. Our team of
                designers and fit specialists is open to designing various
                venues, including cafes, restaurants, bars, and more - all
                created to bring people back.
              </p>
            </div>
          </div>
        </div>
