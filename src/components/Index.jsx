...
import crc from "../assests/images/CRCimg.png";
import Jumehra from "../assests/images/Jumehra.png";
import Halaimg from "../assests/images/Halaimg.png";
import Nandos from "../assests/images/Nandos.png";
...
export default function Index() {
  return (
    <div className="container mx-auto">
      <div className="flex items-center justify-center w-full h-full pt-16 pb-24 sm:py-8 px-4">
