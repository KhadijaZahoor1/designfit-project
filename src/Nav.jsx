...
const Nav = () => {
  ...
  return (
    <div className="lg:flex items-center justify-between bg-white sticky z-[99] top-0 w-full sm:h-[85px]">
      ...
      <div
        className={`sm:bg-palm sm:grid sm:py-[50px] sm:h-[100vh]  lg:items-center lg:pb-0 absolute lg:static bg-white lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 transition-all duration-500 ease-in ${
      ...
      >
        ...
        <div className="flex justify-center">
          <div className="readybtn inline-block lg:hidden">
