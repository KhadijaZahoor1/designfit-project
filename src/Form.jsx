...
const Form = () => {
  return (
    <div
      className={
        "w-screen h-screen md:flex items-center md:justify-center sm:p-[20px] md:p-0 bg-[#353f69b2]"
      }
    >
      <div
        className={
          " flex flex-col sm:justify-center md:justify-start sm:items-center md: items-start bottom-[35px] bg-[ghostwhite] md:rounded-md border-[2px] border-solid shadow-2xl sm:rounded-[80px] sm:h-[93vh] md:h-[77vh] xl:w-[50%] lg:w-[65%] md:w-[86%] sm:w-[100%] p-9"
        }
      >
        <div className="md:self-start">
          <h1 className="sm:text-[26px] md:text-[30px] sm:text-center md:text-start  pb-[35px] font-extrabold text-[#322e2e]">
            Send a Message to our team experts!
          </h1>
        </div>
        <div className="flex sm:flex-col md:flex-row">
          <div className="md:w-[50%]">
            ...
            >
              ...
              {touched.firstName && errors.firstName ? (
                <p className="text-[13px] text-red-600 pb-[5px] ml-[15px]">
                  {errors.firstName}
                </p>
              ) : (
